<?php
    ...
    if (isset($_SESSION['registration_failed']) && $_SESSION['registration_failed'] == 'invalid_input') {
            ...
            <div class="row">
              <div class="col-sm-6 text-black">
                ...
                <div class="d-flex align-items-center h-custom-1 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                  ...
                  <form style="width: 23rem;" action="./scripts/register_confirm.php" method="post">
                    ...
                    <div class="form-outline mb-4">
                      <select class="form-control form-control-lg" name="state" id="state" placeholder="State">
              ...
              <div class="col-sm-6 px-0 d-none d-sm-block" style="max-height:100%">
                <img src="images\img3.webp"
                  alt="Login image" class="w-100" style="object-fit: cover; object-position: left; max-height:100%;">
              </div>
            </div>
          </div>
        </section>
